...
const SidebarData = ({ dashboardType }) => {
  ...
  const Menus = [
    { title: 'Buyers', path: '/buyers', src: <FaUserFriends /> },
    { title: 'Suppliers', path: '/suppliers', src: <FaUserFriends /> },
    { title: 'SupplierForms', path: '/supplier_forms', src: <FaWpforms /> },
    { title: 'BuyerForms', path: '/buyer_forms', src: <FaWpforms /> },
    { title: 'Buyer Forms', path: '/buyer-forms', src: <FaWpforms /> },
    { title: 'Sellers Forms', path: '/seller-forms', src: <FaWpforms /> },
  ];
      ...
      >
        ...
        >
          {Menus.map((menu, index) => (
            <li
              key={index}
              className={`flex items-center gap-x-6 p-6 text-base font-normal rounded-lg cursor-pointer dark:text-gray-200 hover:bg-gray-200 dark:hover:bg-gray-700
              ${menu.gap ? 'mt-9' : 'mt-2'} ${
                location.pathname ===
